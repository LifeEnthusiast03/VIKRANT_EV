...
const Navbar = ({ currentSection, setCurrentSection }) => {
  ...
  return (
    <nav className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50">
      <div className="bg-gray-900/90 backdrop-blur-md border border-gray-600 rounded-full shadow-2xl px-6 py-3">
        <div className="flex items-center space-x-8">
          
          {/* Brand with Blue Glow Animation */}
          <div
            className="text-lg font-bold bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent 
                       hover:scale-105 transform transition duration-300 cursor-pointer whitespace-nowrap"
